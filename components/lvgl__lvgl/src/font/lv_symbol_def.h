...
/*immediately below two definitions added for experiment, to be called in for siderail in main screen*/
#if !defined LV_SYMBOL_CHART 
#define LV_SYMBOL_CHART           "\xEF\x80\x80" /* Example: FontAwesome bar-chart (f080)*/
#endif

#if !defined LV_SYMBOL_MIC
#define LV_SYMBOL_MIC             "\xEF\x80\xb0" /* Example: FontAwesome microphone (f130)*/
#endif
